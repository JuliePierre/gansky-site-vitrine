...
ActiveRecord::Schema.define(version: 2023_07_12_194849) do
  ...
  create_table "flat_facilities", id: :serial, force: :cascade do |t|
    t.integer "flat_id"
    t.integer "facility_id"
    t.integer "number"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["facility_id"], name: "index_flat_facilities_on_facility_id"
    t.index ["flat_id"], name: "index_flat_facilities_on_flat_id"
  end
  ...
  create_table "flats", id: :serial, force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_flats_on_slug", unique: true
  end
  ...
  create_table "user_applications", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["flat_id"], name: "index_user_applications_on_flat_id"
  end
